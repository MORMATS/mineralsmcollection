...
class MineralSpecies(Base):
    ...
    elements: Mapped[str | None] = mapped_column(String(255), deferred=True)
...
class Locality(Base):
    ...
    normalized_key: Mapped[str | None] = mapped_column(String(900), unique=True, index=True, deferred=True)
